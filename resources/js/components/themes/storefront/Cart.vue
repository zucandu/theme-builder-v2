                ...
                <div class="tbl-cart">
                    ...
                    <div v-for="item in items" :key="item.id" class="row mb-3 pb-3 border-bottom">
                        ...
                        <div class="col-9 col-md-4">
                            ...
                            <button class="btn btn-sm btn-link" @click.stop="this.$store.dispatch('cart_remove_product', item.id)">
...
export default {
    ...
    methods: {
        ...
        cart_remove_product(product) {
            this.$store.dispatch('cart_remove_product', product.id);
        },
        initTinySliderNew() {
            tns({
