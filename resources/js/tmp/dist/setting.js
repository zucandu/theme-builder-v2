...
const actions = {
    ...
    setting_initialize({commit}) {
        ...
        commit('SETTING_SET_LANGUAGES', languages)
        commit('SETTING_SET_CURRENCIES', currencies)
        commit('SETTING_SET_TAXES', taxes)
...
const mutations = {
    SETTING_SET_LANGUAGES(state, languages) {
    ...
    SETTING_SET_CURRENCIES(state, currencies) {
    ...
    SETTING_SET_TAXES(state, respTaxes) {
        state.taxes = respTaxes
    },

    SETTING_SET_METATAGS(state, respMetaTags) {
